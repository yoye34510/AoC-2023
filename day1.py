...
def subs(line):
    subs3 = {"one" : '1',"two" : '2',"six" : '6'}
    subs4 = {"four" : '4',"five" : '5',"nine" : '9'}
    subs5 = {"three" : '3',"seven" : '7',"eight" : '8'}
    ...
    while index < len(line):
        s3 = line[index:index+3]
        s4 = line[index:index+4]
        s5 = line[index:index+5]

        if (s3 in subs3.keys()):
            new_string += subs3[s3]
            index += 2
            overlap = True
        elif (s4 in subs4.keys()):
            new_string += subs4[s4]
            index += 3
            overlap = True
        elif (s5 in subs5.keys()):
            new_string += subs5[s5]
            index += 4
            overlap = True
        else:
...
def get_digits(line):
    ...
    for car in line:
        digi = ord(car)
        if digi >= zero and digi <= nine:
            digits.append(digi-zero)
    if (len(digits) == 1):
...
def exo2():
    ...
    for line in input.split('\n'):
        ...
        a,b = get_digits(nl)
        c   = get_calib(a,b)
        #print("line="+line+"  nl="+nl+"   c="+str(c))
        sum += c
    return sum

def main():
    print(" solu exo1 = "+str(exo1()))
    print(" solu exo2 = "+str(exo2()))
